...
class MarkovChain(object):
    ...
    def get_most_connecting_edges(self, k, existingEdgesOnly=True):
        ...
        derivatives. If we increase those edges, K constant decreaese the most"""

        # TODO: when the most connecting edge is a self-link, it may happen that KDA comes into a infinite loop. 
        # For example: when P = [[0,1,0],[1,0,0],[0,0,1]], KDer has the lowest value for self loop (3,3).
    ...
    def plot(self, graphName=None, graphTitle='', markNodeIndexes=[],
        ...
        if selectedColors and enoughSelectedColors:
            ...
            vColors = [x for x in list(colors.CSS4_COLORS.keys())[::-1]
